...
<br>
5. In this example, the word was SCROD. The AI had lexical hallucination by guessing SROOD, explicitly acknowledging that it is not a real word, but proceeding with the guess regardless
![scrod](scrod.png)
![scrod2](scord2.png)

<br>
6. In this example, the word was QUOTA. The AI violated hard-mode rules by failing to maintain the position of a green letter, despite identifying O as green in the third position during the guess STOLE, it moved the letter to the second position in its following guess, TOUGH
![quota](quota.png)
![quota2](quota2.png)
